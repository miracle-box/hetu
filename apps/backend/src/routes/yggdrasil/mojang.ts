...
export const textureOpQuerySchema = t.Object({
	id: t.String(),
...
export type TextureOpQuery = Static<typeof textureOpQuerySchema>;
...
export const MojangApiModel = new Elysia({ name: 'Model.Yggdrasil.Mojang' }).model({
	...
	'yggdrasil.mojang.upload-texture.query': textureOpQuerySchema,
	'yggdrasil.mojang.upload-texture.body': uploadTextureBodySchema,
	'yggdrasil.mojang.reset-texture.query': textureOpQuerySchema,
});
